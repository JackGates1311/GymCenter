...
INSERT INTO workout(workoutId, workoutTypeName, workoutCoaches, workoutDescription, workoutPrice, workoutOrganizationType, 
	workoutLevel, workoutLength, workoutAverageRate, isDeleted) VALUES 
        (1, 'Yoga', 'jovana123', 'Yoga helps to relax better', 1200, 'Individual', 'Amateur', 120, NULL, false),
		(2, 'Yoga', 'branko123/milan123', 'Yoga helps to relax better', 800, 'Group', 'Medium', 150, 8, false),
        (3, 'Fitness', 'branko123', 'Fitness improves your health and mood', 1400, 'Individual', 'Advanced', 240, 9, false),
        (4, 'Fitness', 'jovana123/milan123', 'Fitness improves your health and mood', 1000, 'Group', 'Amateur', 120, NULL, false),
        (5, 'Cardio', 'jovana123', 'Cardio training is the most effective way to remove fet layers, achieve and maintain condition', 1500, 'Individual', 'Advanced', 240, NULL, false),
        (6, 'Cardio', 'jovana123/branko123', 'Cardio training is the most effective way to remove fet layers, achieve and maintain condition', 1100, 'Group', 'Amateur', 240, 9, false),
        (7, 'Yoga', 'branko123', 'Yoga helps to relax better', 1300, 'Individual', 'Medium', 150, 10, true),
        (8, 'Cardio', 'jovana123/branko123', 'Cardio training is the most effective way to remove fet layers, achieve and maintain condition', 1200, 'Group', 'Amateur', 120, NULL, true);
...
INSERT INTO workoutType(workoutTypeName, workoutTypeDetailedDescription, workoutImage) VALUES
    ...
    but also internal organs and glandular system.', 'IMAGEPATH'),
    ...
    you can always adjust the cardio workout to your abilities.', 'IMAGEPATH'),
    ...
    system of exercises that uses mats or appropriate equipment to help you look and feel your best. Regardless of your age or fitness, Pilates will suit you.', 'IMAGEPATH'),
    ...
    interest in this type of aerobics, which bodybuilders use as cardio training.', 'IMAGEPATH');
